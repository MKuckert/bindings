...
{
    public class NamedInstanceRegistryFiller<T> : INamedInstanceRegistryFiller<T>
        where T : class
    {
        ...
        protected virtual void FillFromInstance(INamedInstanceRegistry<T> registry, Type type)
        {
