...
{
    public class UiDatePickerTimeTargetBinding : BaseUiDatePickerTargetBinding
    {
        public UiDatePickerTimeTargetBinding(object target, PropertyInfo targetPropertyInfo)
