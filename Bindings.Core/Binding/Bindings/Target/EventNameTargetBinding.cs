...
{
    public class EventNameTargetBinding<TTarget> : TargetBinding where TTarget : class
    {
        ...
        public EventNameTargetBinding(TTarget target, string targetEventName, bool useEventArgsAsCommandParameter = true) : base(target)
        {
        ...
        public override BindingMode DefaultMode { get; } = BindingMode.OneWay;
