...
namespace Bindings.Core.Binding.Extensions
{
    public static class BindingExtensions
    {
        public static bool ShouldSkipSetValueAsHaveNearlyIdenticalNumericText(this IEditableTextView editableTextView, object target, object value)
        {
            if (value == null)
                return false;
        ...
        public static object MakeSafeValue(this Type propertyType, object value)
        {
            ...
            var autoConverter = BindingSingletonCache.Instance.AutoValueConverters.Find(value.GetType(),
                                                                                            propertyType);
