...
{
    public class CombinerSourceStepDescription : SourceStepDescription
    {
        public IValueCombiner Combiner { get; set; }
        public List<SourceStepDescription> InnerSteps { get; set; }
