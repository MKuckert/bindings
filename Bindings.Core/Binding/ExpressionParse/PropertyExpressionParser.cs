...
namespace Bindings.Core.Binding.ExpressionParse
{
    ...
    public class PropertyExpressionParser : IPropertyExpressionParser
    {
        public IParsedExpression Parse<TObj, TRet>(Expression<Func<TObj, TRet>> propertyPath)
        {
            if (propertyPath.Body is MethodCallExpression expression 
                && expression.Method.Name.Contains("Bind"))
            {
        ...
        public IParsedExpression Parse(LambdaExpression propertyPath)
        {
