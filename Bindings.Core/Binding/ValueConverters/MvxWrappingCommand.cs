...
namespace MvvmCross.Binding.ValueConverters
{
        ...
        : ICommand
    {
        ...
        public bool CanExecute(object parameter = null)
        {
            ...
            if (parameter != null)
                MvxBindingLog.Warning("Non-null parameter will be ignored in MvxWrappingCommand.CanExecute");
        ...
        public void Execute(object parameter = null)
        {
            ...
            if (parameter != null)
                MvxBindingLog.Warning("Non-null parameter overridden in MvxWrappingCommand");
