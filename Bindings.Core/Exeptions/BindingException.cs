...
namespace Bindings.Core.Exeptions
{
    ...
    public class BindingException : Exception
    {
        ...
        public BindingException(string messageFormat, params object[] messageFormatArguments)
        ...
        public BindingException(Exception innerException, string messageFormat, params object[] formatArguments)
